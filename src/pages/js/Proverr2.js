...
import Noimg from "../img/no-photo-or-blank-image-icon-loading-images-or-missing-image-mark-image-not-available-or-image-coming-soon-sign-simple-nature-silhouette-in-frame-isolated-illustration-vector.jpg"
    ...
    return (
        <div>
            ...
            <div className="prover2">
                <div className="prover2-kotta-men">
                    <div className="prover2-search-joy">
                        ...
                        <div className="prover2-mni-search">
                            <form action="">
                                <input type="text" onChange={searchFilter} placeholder='Какой курс вы хотите изучать?' required /><button><box-icon name='search' color='#9da7bb' ></box-icon></button>
                            </form>
                                        ...
                                        <>
                                            ...
                                            <div className="prover2-info-block1">
                                                ...
                                                <div className="prover2-info-block1-text">
                                                    ...
                                                    {item.descriptions == null ? (<p>No destcription</p>) : (<p>{item.description}</p>)}
                ...
                {main.map(item => {
                    if (item.id == localStorage.getItem("filtrid")) {
                        localStorage.setItem("planned_time",item.planned_time)
                        return (
...
<div className="mni-kurs-narxi2">
    ...
    <div className="prover20chech-box-a2">
        ...
        <span><box-icon name='chevron-down' color='#989da2' ></box-icon></span>
                                    ...
                                    <div onClick={()=>buyCourse(item.id)} className="mni-buton-iikki-yo">
            ...
            <div className="mni-orta-bloxk-mediaa">
                <div className="mni-orta-kota-media">
                    <div className="mni-media-orta-input">
                        <form action="">
                            <input type="text" onChange={searchFilter} placeholder='Какой курс вы хотите изучать?' required /><button id="input-neposhlushni"><box-icon name='search' color='#9da7bb' ></box-icon></button>
                        </form>
                    </div>
